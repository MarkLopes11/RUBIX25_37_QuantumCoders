  ...
  return (
    <section className="flex justify-center items-center bg-black py-20 relative">
      ...
      <div className="text-center relative z-10">
        <h1 className="text-4xl font-bold text-white mb-6">AI Fashion Wardrobe Assistant</h1>
        <p className="text-lg text-white mb-8">Smart suggestions and wardrobe management, all in one place!</p>
